...
double activacion(double *pesos, int *entrada, double b) {
    ...
    // Aplicamos la función sigmoidal
    return 1.0 / (1.0 + exp(-suma)); // Sigmoidal: 1 / (1 + exp(-x))
}
...
int main() {
    ...
    printf("Resultados del perceptrón para la tabla AND (usando activación sigmoidal):\n");
